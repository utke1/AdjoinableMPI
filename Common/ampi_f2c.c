...
void ampi_comm_rank_(int *commF, int *rank, int* err_code) {
  MPI_Comm comm = MPI_COMM_WORLD ; /* <== PATCH!! */
  *err_code = MPI_Comm_rank(comm, rank);
}
